...
class TestElement:
    def test_element_validation(self, simple_element):
        expected_errors = {'truth_table': ['Поле должно быть массивом с размерностью 3'], '__all__': ['Количество возможных комбинаций вх. сигналов д.б. = 2^(количество входных сигналов)']}
