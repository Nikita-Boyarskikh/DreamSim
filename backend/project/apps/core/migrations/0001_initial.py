# Generated by Django 2.1.7 on 2019-04-06 11:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element_type', models.CharField(choices=[('SOURCE', 'Источник'), ('GROUND', 'Земля'), ('GENERATOR', 'Генератор'), ('ANALYZER', 'Анализатор'), ('AND', 'И'), ('OR', 'ИЛИ'), ('NOT', 'НЕ'), ('XOR', 'Исключающее ИЛИ'), ('NOR', 'ИЛИ-НЕ'), ('NAND', 'И-НЕ'), ('USER', 'Пользовательский')], max_length=30, verbose_name='Тип элемента')),
                ...
                ('truth_table', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(choices=[(0, 'Ложь'), (1, 'Истина')], verbose_name='Ложь/Истина'), size=None), size=None, verbose_name='Таблица истинности'), size=None, verbose_name='Ось времени')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Создатель ЛЭ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Element', verbose_name='ИД Элемента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Создатель схемы')),
            ],
            options={
                'verbose_name': 'Схема',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Element', verbose_name='ИД элемента')),
                ('scheme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Scheme', verbose_name='ИД схемы')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_scheme_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_link', to='core.SchemeElement', verbose_name='ИД ЛЭ схемы входа')),
                ('output_scheme_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='out_link', to='core.SchemeElement', verbose_name='ИД ЛЭ схемы выхода')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Tag', verbose_name='ИД тега'),
        ),
        migrations.AddField(
            model_name='scheme',
            name='elements',
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Unit', verbose_name='ИД единиц измерения'),
        ),
    ]
