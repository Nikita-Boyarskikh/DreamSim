    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element_type', models.CharField(choices=[(apps.core.models.element.ElementType('Источник'), 'Источник'), (apps.core.models.element.ElementType('Земля'), 'Земля'), (apps.core.models.element.ElementType('Генератор'), 'Генератор'), (apps.core.models.element.ElementType('Анализатор'), 'Анализатор'), (apps.core.models.element.ElementType('И'), 'И'), (apps.core.models.element.ElementType('ИЛИ'), 'ИЛИ'), (apps.core.models.element.ElementType('НЕ'), 'НЕ'), (apps.core.models.element.ElementType('Исключающее ИЛИ'), 'Исключающее ИЛИ'), (apps.core.models.element.ElementType('ИЛИ-НЕ'), 'ИЛИ-НЕ'), (apps.core.models.element.ElementType('И-НЕ'), 'И-НЕ'), (apps.core.models.element.ElementType('Пользовательский'), 'Пользовательский')], max_length=30, verbose_name='Тип элемента')),
                ('array_of_inputs', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, verbose_name='Массив имён входов'), size=None)),
                ('array_of_outputs', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, verbose_name='Массив имён выходов'), size=None)),
                ...
                ('Создатель ЛЭ', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Создатель схемы', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Схема',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('coordinates', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(verbose_name='Координаты'), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinate_array', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(verbose_name='Массив координат'), size=None), size=None)),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Название')),
                ('id_input_scheme_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_link', to='core.SchemeElement', verbose_name='ИД ЛЭ схемы входа')),
                ('id_output_scheme_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='out_link', to='core.SchemeElement', verbose_name='ИД ЛЭ схемы выхода')),
            ],
            options={
